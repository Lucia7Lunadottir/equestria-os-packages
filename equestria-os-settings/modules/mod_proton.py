"""Proton / Wine module — inline global settings + cache cleaner."""
...
class ProtonModule(BaseModule):
    ...
    def build_widget(self) -> QWidget:
        ...
        self._cb_dxvk  = QCheckBox("DXVK")
        self._cb_vkd3d = QCheckBox("VKD3D-Proton")
        self._cb_esync = QCheckBox("Esync")
        self._cb_fsync = QCheckBox("Fsync")
