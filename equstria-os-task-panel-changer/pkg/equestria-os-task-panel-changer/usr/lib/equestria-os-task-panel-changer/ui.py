...
class Ui_MainWindow:
    ...
    def _setup_editor_page(self):
        ...
        color_lo.setSpacing(6)
        self.lbl_ed_color_dark_icon = QLabel("🌙")
        self.btn_ed_color_dark = QPushButton()
        self.btn_ed_color_dark.setObjectName("ColorSwatchBtn")
        self.btn_ed_color_dark.setFixedSize(40, 24)
        self.lbl_ed_color_light_icon = QLabel("☀️")
        self.btn_ed_color_light = QPushButton()
        self.btn_ed_color_light.setObjectName("ColorSwatchBtn")
        self.btn_ed_color_light.setFixedSize(40, 24)
        color_lo.addWidget(self.lbl_ed_color_dark_icon)
        ...
        theme_lo.setSpacing(6)
        self.btn_ed_theme_dark = QPushButton("🌙 Dark")
        self.btn_ed_theme_dark.setProperty("cssClass", "theme-btn")
        self.btn_ed_theme_dark.setProperty("active", "true")
        self.btn_ed_theme_light = QPushButton("☀️ Light")
        self.btn_ed_theme_light.setProperty("cssClass", "theme-btn")
